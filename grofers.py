...
def func(data):
    ...
    for item in data["product"]:
            ...
            driver.find_element_by_class_name("react-autosuggest__input").send_keys(Keys.CONTROL + "a")
            driver.find_element_by_class_name("react-autosuggest__input").send_keys(Keys.DELETE)
            driver.find_element_by_class_name("react-autosuggest__input").send_keys(item)
            driver.find_element_by_class_name("react-autosuggest__input").send_keys(Keys.RETURN)
